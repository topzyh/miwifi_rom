...
# wget http://mtool.topsts.cn/tools/install.sh -O /tmp/install.sh && chmod +x /tmp/install.sh && /tmp/install.sh
#----------------------------------------------------------------*/
clear
...
echo "来自分流节点更新:blog.ouoshop.com"
...
url="http://mtool.topsts.cn/tools/appstore/$model"
